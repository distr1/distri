...
func TestReaddir(t *testing.T) {
	...
	f, err := os.Open("/home/michael/distri/build/distri/pkg/ack-amd64-2.24-6.squashfs")
	if err != nil {
		t.Fatal(err)
	}
	defer f.Close()
...
func TestReaddirSmoke(t *testing.T) {
	...
	for _, fn := range []string{
		...
		// blocks.
		"/home/michael/distri/build/distri/pkg/bash-amd64-5.0-4.squashfs",

		// cmake exercises the code path where the root directory entries are
		// located outside of the first block.
		"/home/michael/distri/build/distri/pkg/cmake-amd64-3.12.2-7.squashfs",
	} {
		// TODO: ship testdata files generated by mksquashfs
		f, err := os.Open(fn)
		if err != nil {
...
func TestReadfile(t *testing.T) {
	...
	for i := 0; i < 2; i++ {
		...
		if got, want := sum, "c215cb7884a0abf611898ef89f35aa19"; got != want {
