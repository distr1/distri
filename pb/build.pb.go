...
func (m *Build) GetWritableSourcedir() bool {
	if m != nil && m.WritableSourcedir != nil {
		return *m.WritableSourcedir
	}
	return false
}

func (m *Build) GetInTreeBuild() bool {
	if m != nil && m.InTreeBuild != nil {
		return *m.InTreeBuild
	}
	return false
}

func (m *Build) GetAckMissingDwarf() string {
	if m != nil && m.AckMissingDwarf != nil {
		return *m.AckMissingDwarf
	}
	return ""
}
...
var fileDescriptor_14ce178a580e4ede = []byte{
	...
	,
}
