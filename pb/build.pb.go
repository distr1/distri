...
type CBuilder struct {
	...
	// package upstream.
	//
	// Deprecated: use the top-level copy_to_builddir instead
...
func (m *CMakeBuilder) GetCopyToBuilddir() bool {
	if m != nil && m.CopyToBuilddir != nil {
		return *m.CopyToBuilddir
	}
	return false
...
var fileDescriptor_14ce178a580e4ede = []byte{
	...
	,
}
